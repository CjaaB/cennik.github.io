...
3. **Android:** zaloguj się → ikona pobierania w panelu **lub** menu Chrome ⋮ → „Zainstaluj aplikację”.
4. **iPhone:** Safari → **Udostępnij** → **Dodaj do ekranu początkowego** (nie ma przycisku „Zainstaluj” jak na Androidzie).
5. To **inna ikona** niż apka klienta (`/app/` vs `/app/admin/`).
...
W CAD Admin po zalogowaniu na dole powinny być zakładki: **Wiadomości | Statystyki | Ustawienia**.

(function () {
    ...
    const I18N = {
        pl: {
            ...
            serviceInfoAria: "Poka\u017c opis us\u0142ugi",
            ...
            weatherGuideTitle: "Co warto zrobi\u0107",
            weatherDayGood: "OK na zewn\u0105trz",
            weatherDayCaution: "Ustal godzin\u0119",
            weatherDayBad: "S\u0142abe warunki",
            weatherGuideGood1: "Dzi\u015b mo\u017cesz spokojnie um\u00f3wi\u0107 mycie zewn\u0119trzne lub pe\u0142ny pakiet.",
            weatherGuideGood2: "Wosk, quick detailer i ochrona lakieru \u2014 te\u017c dobry moment.",
            weatherGuideGood3: "Czyszczenie wn\u0119trza mo\u017cesz zrobi\u0107 w ka\u017cdych warunkach.",
            weatherGuideCaution1: "Przed przyjazdem potwierd\u017a godzin\u0119 \u2014 pogoda mo\u017ce si\u0119 zmieni\u0107.",
            weatherGuideCaution2: "Mycie zewn\u0119trzne cz\u0119sto si\u0119 da, ale zale\u017cy od deszczu i wiatru na miejscu.",
            weatherGuideCaution3: "Wn\u0119trze, sk\u00f3ra i tapicerka \u2014 bez ryzyka pogodowego.",
            weatherGuideBad1: "Dzi\u015b lepiej skupi\u0107 si\u0119 na wn\u0119trzu, sk\u00f3rze lub tapicerce.",
            weatherGuideBad2: "Na mycie zewn\u0119trzne lepszy dzie\u0144: {day}.",
            weatherGuideBad3: "Napisz na WhatsApp \u2014 ustalimy termin pasuj\u0105cy do pogody.",
            weatherGuideFallback1: "Prognoza chwilowo niedost\u0119pna \u2014 napisz, ustalimy dogodny termin.",
            weatherGuideFallback2: "Us\u0142ugi wn\u0119trza mo\u017cna zaplanowa\u0107 niezale\u017cnie od pogody.",
            today: "Dzi\u015b",
            tomorrow: "Jutro",
            ...
            showroomFxToast: "Pakiet Showroom \u2014 lakier jak ze salonu.",
            ...
            pdfPrintBlocked: "Nie udało się otworzyć okna druku. Spróbuj ponownie lub użyj menu przeglądarki (Drukuj → Zapisz jako PDF).",
        ...
        nl: {
            ...
            serviceInfoAria: "Toon dienstbeschrijving",
            ...
            weatherGuideTitle: "Wat kun je doen",
            weatherDayGood: "OK buiten",
            weatherDayCaution: "Tijd afstemmen",
            weatherDayBad: "Slecht weer",
            weatherGuideGood1: "Vandaag kun je gerust buiten wassen of een volledig pakket plannen.",
            weatherGuideGood2: "Wax, quick detailer en lakbescherming \u2014 ook een goed moment.",
            weatherGuideGood3: "Interieurreiniging kan altijd, ongeacht het weer.",
            weatherGuideCaution1: "Bevestig de tijd vlak voor aankomst \u2014 het weer kan veranderen.",
            weatherGuideCaution2: "Buiten wassen kan vaak nog, maar hangt af van regen en wind ter plaatse.",
            weatherGuideCaution3: "Interieur, leer en bekleding \u2014 geen weersrisico.",
            weatherGuideBad1: "Vandaag beter focussen op interieur, leer of bekleding.",
            weatherGuideBad2: "Beter moment voor buiten wassen: {day}.",
            weatherGuideBad3: "Stuur een WhatsApp \u2014 we plannen een moment dat bij het weer past.",
            weatherGuideFallback1: "Verwachting tijdelijk niet beschikbaar \u2014 stuur een bericht, we plannen een moment.",
            weatherGuideFallback2: "Interieurdiensten kunnen onafhankelijk van het weer worden ingepland.",
            today: "Vandaag",
            tomorrow: "Morgen",
            ...
            showroomFxToast: "Showroom pakket \u2014 glans als in de showroom.",
            ...
            pdfPrintBlocked: "De browser blokkeerde het afdrukvenster. Sta pop-ups toe en probeer opnieuw. Schakel \u201eKop- en voetteksten\u201d uit in het afdrukvenster als je een bestandspad onderaan ziet.",
        ...
        en: {
            ...
            quoteServiceFallback: "Service",
            showroomFxToast: "Showroom package \u2014 showroom-grade gloss."
        }
    };
    ...
    const STATIC_TEXT_EN = {
        ...
        "Drukuj / Zapisz jako PDF": "Print / save as PDF",
        "Zarezerwuj Termin Online": "Book online",
        "Galeria": "Gallery",
        "Detailing w praktyce": "Detailing in practice",
        "Zdjęcia z realizacji — przewijaj w bok lub kliknij, aby zobaczyć pełny podgląd.": "Work photos — swipe sideways or tap for full view.",
        "Zdjęcia tymczasowe z": "Temporary photos from",
        "— buduję własną galerię realizacji.": "— I'm building my own gallery of real work.",
        "Detailing — zdjecie 1": "Detailing — photo 1",
        "Detailing — zdjecie 2": "Detailing — photo 2",
        "Detailing — zdjecie 3": "Detailing — photo 3",
        "Detailing — zdjecie 4": "Detailing — photo 4",
        "Detailing — zdjecie 5": "Detailing — photo 5",
        "Detailing — zdjecie 6": "Detailing — photo 6",
        "Detailing — zdjecie 7": "Detailing — photo 7",
        "Gdzie pracuję": "Where I work",
        "Maarssen i okolice Utrecht": "Maarssen and Utrecht area",
        "Pracuję lokalnie w rejonie Maarssen. Dokładny adres podaję po kontakcie.": "I work locally around Maarssen. Exact address after contact.",
        "Zapytaj o termin": "Ask about availability",
        "Kalendarz online": "Online calendar",
        ...
        "Ładowanie": "Loading",
        "Detailing w Maarssen (NL). Sprawdź wycenę w kalkulatorze i umów termin — jasny zakres, bez niedomówień.": "Detailing in Maarssen (NL). Check the quote in the calculator and book — clear scope, no surprises.",
        "Detailing w Maarssen. Wycena online, jasny proces.": "Detailing in Maarssen. Online quote, clear process.",
        "Cztery etapy. Jasny zakres. Zero niedomówień.": "Four steps. Clear scope. No surprises.",
        "Jak pracuję": "How I work",
        "Od przyjęcia auta do odbioru bez niedomówień": "From drop-off to pickup, without misunderstandings",
        "Przyjęcie": "Drop-off",
        "Przyjęcie auta": "Vehicle intake",
        "Detailing": "Detailing",
        "Realizacja": "In progress",
        "Nowe": "New",
        "W trakcie": "In progress",
        "Aktywna": "Active",
        "Gotowe": "Done",
        "3 wybrane": "3 selected",
        "Przyjęcie i ustalenie zakresu": "Intake and scope",
        "Wybierasz usługi w kalkulatorze. Na miejscu doprecyzowujemy model, stan auta i oczekiwany efekt.": "Pick services in the calculator. On site we confirm model, condition and expected result.",
        "2 miejsca": "2 spots",
        "Protokół przed startem prac": "Pre-work protocol",
        "Oględziny i protokół": "Inspection and protocol",
        "Sprawdzam lakier, wnętrze i zakres prac. Ustalamy finalną cenę zanim zacznę.": "I check paint, interior and scope. Final price is agreed before I start.",
        "Wykończenie": "Finishing",
        "Szacowany czas": "Estimated time",
        "Detailing etapami": "Step-by-step detailing",
        "Pracuję spokojnie, bez pośpiechu. Każdy etap ma kontrolę jakości przed kolejnym.": "I work calmly with quality checks between each step.",
        "Zakończone": "Completed",
        "Potwierdź odbiór": "Confirm pickup",
        "Odbiór bez niedomówień": "Pickup without surprises",
        "Przechodzimy przez efekt razem. Wiesz co zrobiłem, ile kosztowało i jak dbać o auto dalej.": "We review the result together. You know what was done, the cost and how to maintain the car.",
        "Suma orientacyjna": "Estimated total",
        "Termin": "Book",
        "Chemia i akcesoria do mycia, felg i wnętrza — sprawdzone w codziennej pracy.": "Wash, wheel and interior products proven in daily work.",
        "Powłoki i zabezpieczenia lakieru — połysk i trwała ochrona.": "Paint protection and coatings — gloss and lasting protection.",
        "Skuteczna chemia do mycia, dekontaminacji i codziennej pielęgnacji.": "Effective wash, decon and daily care chemistry.",
        "Eleganckie zapachy i estetyczne wykończenie wnętrza.": "Elegant scents and refined interior finish.",
        "Proste, skuteczne produkty do detailingu na co dzień.": "Simple, effective daily detailing products.",
        "Własne receptury testowane w praktyce — powtarzalny efekt.": "Own formulas tested in practice — repeatable results.",
        "Produkty i edukacja dla osób, które chcą rozumieć proces.": "Products and education for those who want to understand the process.",
        "Pędzle, mikrofibry i narzędzia do precyzyjnej pracy.": "Brushes, microfibers and tools for precise work.",
        "Miękkie mikrofibry i ręczniki do bezpiecznego osuszania.": "Soft microfibers and towels for safe drying."
    };
    ...
    const STATIC_TEXT_NL = {
        ...
        "Detailing w Maarssen (NL). Sprawdź wycenę w kalkulatorze i umów termin — jasny zakres, bez niedomówień.": "Detailing in Maarssen (NL). Bekijk de prijs in de calculator en plan een afspraak — duidelijke scope, zonder misverstanden.",
        "Detailing w Maarssen. Wycena online, jasny proces.": "Detailing in Maarssen. Online prijs, duidelijk proces.",
        "Cztery etapy. Jasny zakres. Zero niedomówień.": "Vier stappen. Duidelijke scope. Geen misverstanden.",
        "Przyjęcie auta": "Auto-inname",
        "Inspekcja": "Inspectie",
        "Detailing": "Detailing",
        "Realizacja": "Uitvoering",
        "Nowe": "Nieuw",
        "W trakcie": "Bezig",
        "Aktywna": "Actief",
        "Gotowe": "Klaar",
        ...
        "Usługi": "Diensten",
        "3 wybrane": "3 gekozen",
        "Wycena orientacyjna": "Indicatieve prijs",
        "Przyjęcie i ustalenie zakresu": "Inname en scope afstemmen",
        "Wybierasz usługi w kalkulatorze. Na miejscu doprecyzowujemy model, stan auta i oczekiwany efekt.": "Je kiest diensten in de calculator. Ter plaatse stemmen we model, staat en gewenst resultaat af.",
        "Lakier": "Lak",
        "Wnętrze": "Interieur",
        "Plamy": "Vlekken",
        "2 miejsca": "2 plekken",
        "Protokół przed startem prac": "Protocol vóór start",
        "Oględziny i protokół": "Inspectie en protocol",
        "Sprawdzam lakier, wnętrze i zakres prac. Ustalamy finalną cenę zanim zacznę.": "Ik controleer lak, interieur en scope. We spreken de finale prijs af vóór ik begin.",
        "Mycie": "Wassen",
        "Wykończenie": "Afwerking",
        "Szacowany czas": "Geschatte tijd",
        "Detailing etapami": "Detailing in stappen",
        "Pracuję spokojnie, bez pośpiechu. Każdy etap ma kontrolę jakości przed kolejnym.": "Ik werk rustig en gecontroleerd. Elke stap heeft een kwaliteitscheck.",
        "Status": "Status",
        "Zakończone": "Afgerond",
        "Płatność": "Betaling",
        "Odbiór": "Ophalen",
        "Potwierdź odbiór": "Bevestig ophalen",
        "Odbiór bez niedomówień": "Ophalen zonder misverstanden",
        "Przechodzimy przez efekt razem. Wiesz co zrobiłem, ile kosztowało i jak dbać o auto dalej.": "We lopen samen het resultaat door. Je weet wat ik deed, wat het kostte en hoe je de auto onderhoudt.",
        "Suma orientacyjna": "Indicatief totaal",
        "Termin": "Afspraak",
        "Chemia i akcesoria do mycia, felg i wnętrza — sprawdzone w codziennej pracy.": "Chemie en accessoires voor wassen, velgen en interieur — bewezen in dagelijks werk.",
        "Powłoki i zabezpieczenia lakieru — połysk i trwała ochrona.": "Lakbescherming en coatings — glans en duurzame bescherming.",
        "Skuteczna chemia do mycia, dekontaminacji i codziennej pielęgnacji.": "Effectieve chemie voor wassen, decontaminatie en dagelijks onderhoud.",
        "Eleganckie zapachy i estetyczne wykończenie wnętrza.": "Elegante geuren en mooie interieurafwerking.",
        "Proste, skuteczne produkty do detailingu na co dzień.": "Eenvoudige, effectieve detailingproducten voor dagelijks gebruik.",
        "Własne receptury testowane w praktyce — powtarzalny efekt.": "Eigen formules getest in de praktijk — herhaalbaar resultaat.",
        "Produkty i edukacja dla osób, które chcą rozumieć proces.": "Producten en educatie voor wie het proces wil begrijpen.",
        "Pędzle, mikrofibry i narzędzia do precyzyjnej pracy.": "Kwasten, microvezels en tools voor precies werk.",
        "Miękkie mikrofibry i ręczniki do bezpiecznego osuszania.": "Zachte microvezels en doeken voor veilig drogen.",
        ...
        "Drukuj / Zapisz jako PDF": "Afdrukken / opslaan als PDF",
        ...
        "Galeria": "Galerij",
        "Detailing w praktyce": "Detailing in beeld",
        "Zdjęcia z realizacji — przewijaj w bok lub kliknij, aby zobaczyć pełny podgląd.": "Foto's van werk — veeg opzij of tik voor volledig beeld.",
        "Zdjęcia tymczasowe z": "Tijdelijke foto's van",
        "Unsplash": "Unsplash",
        "— buduję własną galerię realizacji.": "— ik bouw mijn eigen galerij met echte resultaten.",
        "Detailing — zdjecie 1": "Detailing — foto 1",
        "Detailing — zdjecie 2": "Detailing — foto 2",
        "Detailing — zdjecie 3": "Detailing — foto 3",
        "Detailing — zdjecie 4": "Detailing — foto 4",
        "Detailing — zdjecie 5": "Detailing — foto 5",
        "Detailing — zdjecie 6": "Detailing — foto 6",
        "Detailing — zdjecie 7": "Detailing — foto 7",
        "Gdzie pracuję": "Waar ik werk",
        "Maarssen i okolice Utrecht": "Maarssen en omgeving Utrecht",
        "Pracuję lokalnie w rejonie Maarssen. Dokładny adres podaję po kontakcie.": "Ik werk lokaal rond Maarssen. Het exacte adres geef ik na contact.",
        "Zapytaj o termin": "Vraag een afspraak",
        "Kalendarz online": "Online agenda",
    ...
    const i18nSource = { captured: false, textNodes: [], attrs: [] };
    ...
    function captureI18nSource() {
        if (i18nSource.captured || !document.body) return;
        i18nSource.captured = true;

        const skipSubtree = (el) => {
            if (!el) return true;
            if (el.closest("#infoModal, #weatherModal, #galleryLightbox, #site-install-modal")) return true;
        ...
        const walker = document.createTreeWalker(document.body, NodeFilter.SHOW_TEXT, {
            acceptNode(node) {
                ...
                if (skipSubtree(parent)) return NodeFilter.FILTER_REJECT;
                return node.nodeValue.trim() ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_SKIP;
            }
        });

        while (walker.nextNode()) {
            i18nSource.textNodes.push({ node: walker.currentNode, value: walker.currentNode.nodeValue });
        }
        ...
        document.querySelectorAll("*").forEach((el) => {
            ...
            ATTRS_TO_TRANSLATE.forEach((attr) => {
                ...
                i18nSource.attrs.push({ el, attr, value: el.getAttribute(attr) });
            });
        });
    }

    function translateFromSource(sourceText, nextLocale) {
        if (!sourceText) return sourceText;
        if (nextLocale === "pl") return sourceText;
        const dictionary = nextLocale === "nl" ? STATIC_TEXT_NL : STATIC_TEXT_EN;
        return translateValue(sourceText, dictionary);
    }

    function applyStaticTranslations(nextLocale) {
        captureI18nSource();

        i18nSource.textNodes.forEach(({ node, value }) => {
            if (node.isConnected) node.nodeValue = translateFromSource(value, nextLocale);
        });

        i18nSource.attrs.forEach(({ el, attr, value }) => {
            if (el.isConnected) el.setAttribute(attr, translateFromSource(value, nextLocale));
        });
    ...
    function setLocale(next) {
        ...
        window.CAD_LangSwitch?.syncAll?.(locale);
    ...
    function setupLangBar() {
        if (!window.CAD_LangSwitch || document.querySelector(".cad-lang-switch--fixed")) return;
        window.CAD_LangSwitch.mountFixed(
            () => locale,
            (next) => setLocale(next)
        );
    }
    ...
    function setupToolbar() {
        ...
        toolbar.className = "prefs-toolbar prefs-toolbar--currency";
        toolbar.innerHTML = `
    ...
    function init() {
        document.body?.classList.add("cad-js-ready");
        ...
        if (urlLang && ["pl", "nl", "en"].includes(urlLang)) {
            setLocale(urlLang);
        } else if (!document.querySelector(".prefs-toolbar")) {
            setLocale(locale);
        }
    ...
    window.CAD_Features = {
        ...
        translateStatic(value) {
            return translateFromSource(value, locale);
        },
        setCurrency,
        setLocale,
        hasAnalyticsConsent,

(function () {
    ...
    const I18N = {
        pl: {
            payLabel: "DO ZAP\u0141ATY:",
            cookieText: "U\u017cywamy localStorage, licznika wizyt oraz (po podaniu ID) Google Analytics. Klikaj\u0105c \u201eAkceptuj\u0119\u201d, zgadzasz si\u0119 na niezb\u0119dne dane techniczne.",
            cookieAccept: "Akceptuj\u0119",
            cookieDecline: "Tylko niezb\u0119dne"
        },
        nl: {
            payLabel: "TE BETALEN:",
            cookieText: "We gebruiken localStorage, een bezoekerenteller en (met ID) Google Analytics. Met \u201eAccepteren\u201d ga je akkoord met noodzakelijke technische gegevens.",
    ...
    function getQuoteSummary() {
        ...
        return { selectedSize, lines, totalEur, timeText, serviceCount: selected.length };
    }
    ...
    function buildWhatsAppUrl() {
        ...
        if (locale === "nl") {
            body = q.serviceCount === 0
                ? "Hoi! Ik heb interesse in detailing. Kan ik een vrije datum vragen?"
                : `Hoi! Offerte uit calculator:\nKlasse: ${q.selectedSize}\n${q.lines.join("\n")}\nTotaal: ${totalText}\nTijd: ${q.timeText}\nMag ik een vrije datum?`;
        } else {
            body = q.serviceCount === 0
                ? "Cze\u015b\u0107! Interesuje mnie detailing. Chcia\u0142bym zapyta\u0107 o wolny termin."
                : `Cze\u015b\u0107! Wycena z kalkulatora:\nKlasa: ${q.selectedSize}\n${q.lines.join("\n")}\nSuma: ${totalText}\nCzas: ${q.timeText}\nChcia\u0142bym zapyta\u0107 o wolny termin.`;
        }

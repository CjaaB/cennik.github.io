(function () {
    ...
    function applyStaticTranslations(nextLocale) {
        const dictionary = nextLocale === "nl" ? STATIC_TEXT_NL : STATIC_TEXT_PL;
        ...
        document.querySelectorAll(".knowledge-accordion details").forEach((item, index) => {
            ...
            if (summary) summary.textContent = entry[0];
    ...
    function getInitialLocale() {
        ...
        if (paramLocale === "nl" || paramLocale === "pl") return paramLocale;
        const savedLocale = localStorage.getItem(cfg.storageKeys.locale);
        if (savedLocale === "nl" || savedLocale === "pl") return savedLocale;
    ...
    function setLocale(next) {
        ...
        document.querySelector('meta[property="og:locale"]')?.setAttribute("content", locale === "nl" ? "nl_NL" : "pl_PL");
